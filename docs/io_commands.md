...
The SK-2310G2 is a specialized I/O controller designed for machine supervision, with dedicated hardware for supervisory functions alongside a set of general-purpose I/O features.
